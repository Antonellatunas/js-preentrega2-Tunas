...
class Empleado {
    ...
    cambiarNombre(nombre) {
      this.nombre = nombre;
      alert("El nombre fue cambiado con éxito");
    }
    cambiarEdad(edad) {
      if (isNaN(edad)) {
      ...
      this.edad = edad;
      alert("La edad fue cambiada con éxito");
    }
    cambiarPuesto(puesto) {
      this.puesto = puesto;
      alert("El puesto fue cambiado con éxito");
    }
  }
  ...
  let empleados = [
    new Empleado("Catalina", "Jr", 22),
    new Empleado("Florencia", "Jr", 27),
    new Empleado("Sofia", "Sr", 32),
    new Empleado("Lucas", "Ssr", 36),
  ];
